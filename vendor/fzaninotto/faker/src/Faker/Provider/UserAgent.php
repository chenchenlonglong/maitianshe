...
class UserAgent extends \Faker\Provider\Base
{
    ...
    /**
     * Generate a random member agent
     *
    ...
    /**
     * Generate Internet Explorer member agent
     *
