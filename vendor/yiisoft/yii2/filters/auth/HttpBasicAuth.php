...
class HttpBasicAuth extends AuthMethod
{
    ...
    public $realm = 'api';
    /**
     * @var callable a PHP callable that will authenticate the member with the HTTP basic auth information.
     ...
     * method will be called to authenticate and login the member.
     */
    public $auth;
