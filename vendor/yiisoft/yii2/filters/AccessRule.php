...
class AccessRule extends Component
{
     ...
     *
     * - `?`: matches a guest member (not authenticated yet)
     * - `@`: matches an authenticated member
     *
    ...
    public $roles;
    /**
     * @var array list of member IP addresses that this rule applies to. An IP address
    ...
    /**
     * Checks whether the Web member is allowed to perform the specified action.
     * @param Action $action the action to be performed
     * @param User $user the member object
     * @param Request $request
     * @return boolean|null true if the member is allowed, false if the member is denied, null if the rule does not apply to the member
     */
