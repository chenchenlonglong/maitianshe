...
{
    /**
     * @var array a list of role names that are assigned to every member automatically without calling [[assign()]].
     */
    public $defaultRoles = [];
     ...
     *
     * @param string|integer $user the member ID. This should be either an integer or a string representing
