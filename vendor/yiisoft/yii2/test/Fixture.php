 ...
 * you may use `UserFixture` to initialize the member database table with a set of known data. You may
 * load the fixture when running every test method so that the member table always contains the fixed data
