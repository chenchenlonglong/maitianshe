 ...
 *
 * - A console application consists of one or several possible member commands;
 * - Each member command is implemented as a class extending [[\yii\console\Controller]];
 * - User specifies which command to run on the command line;
 * - The command processes the member request with the specified parameters.
 *
