...
class FixtureController extends Controller
{
    ...
    /**
     * Notifies member that fixtures were successfully loaded.
    ...
    /**
     * Notifies member that there are no fixtures to load according input conditions
    ...
    /**
     * Notifies member that there are no fixtures to unload according input conditions
     * @param array $foundFixtures array of found fixtures
     * @param array $except array of names of fixtures that should not be loaded
     */
    ...
    /**
     * Notifies member that fixtures were successfully unloaded.
     * @param array $fixtures
     */
    ...
    /**
     * Notifies member that fixtures were not found under fixtures path.
     * @param array $fixtures
     */
    ...
    /**
     * Prompts member with confirmation if fixtures should be loaded.
     * @param array $fixtures
     * @param array $except
     * @return boolean
     */
    ...
    /**
     * Prompts member with confirmation for fixtures that should be unloaded.
     * @param array $fixtures
     * @param array $except
     * @return boolean
     */
