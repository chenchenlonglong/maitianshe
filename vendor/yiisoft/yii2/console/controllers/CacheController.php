...
class CacheController extends Controller
{
    ...
    /**
     * Notifies member that given caches are found and can be flushed.
    ...
    /**
     * Notifies member that there was not found any cache in the system.
     */
    ...
    /**
     * Notifies member that given cache components were not found in the system.
    ...
    /**
     * Prompts member with confirmation if caches should be flushed.
     * @param array $cachesNames
     * @return boolean
     */
