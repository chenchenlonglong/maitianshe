...
class QueryBuilder extends \yii\base\Object
{
     ...
     *
     * ```php
     * $sql = $queryBuilder->insert('member', [
     *     'name' => 'Sam',
     *     'age' => 30,
     * ], $params);
     * ```
     ...
     *
     * ```php
     * $sql = $queryBuilder->batchInsert('member', ['name', 'age'], [
     *     ['Tom', 30],
     *     ['Jane', 20],
     *     ['Linda', 25],
     * ]);
     ...
     * ```php
     * $params = [];
     * $sql = $queryBuilder->update('member', ['status' => 1], 'age > 30', $params);
     * ```
     *
     * The method will properly escape the table and column names.
     *
     ...
     *
     * ```php
     * $sql = $queryBuilder->delete('member', 'status = 0');
     * ```
     *
     * The method will properly escape the table and column names.
     *
     ...
     *
     * ```php
     * $sql = $queryBuilder->createTable('member', [
     *  'id' => 'pk',
     *  'name' => 'string',
     *  'age' => 'integer',
     * ]);
