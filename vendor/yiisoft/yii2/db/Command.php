 ...
 *
 * ```php
 * $users = $connection->createCommand('SELECT * FROM member')->queryAll();
 * ```
 *
 ...
 *
 * ```php
 * $connection->createCommand()->insert('member', [
 *     'name' => 'Sam',
 *     'age' => 30,
 * ])->execute();
 * ```
...
class Command extends Component
{
     ...
     *
     * ```php
     * $connection->createCommand()->batchInsert('member', ['name', 'age'], [
     *     ['Tom', 30],
     *     ['Jane', 20],
     *     ['Linda', 25],
     * ])->execute();
     ...
     *
     * ```php
     * $connection->createCommand()->update('member', ['status' => 1], 'age > 30')->execute();
     * ```
     *
     ...
     *
     * ```php
     * $connection->createCommand()->delete('member', 'status = 0')->execute();
     * ```
     *
