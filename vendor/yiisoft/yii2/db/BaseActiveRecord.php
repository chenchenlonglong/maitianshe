...
abstract class BaseActiveRecord extends Model implements ActiveRecordInterface
{
     ...
     * potential conflicts. In case when a member attempts to save the record upon some staled data
     * (because another member has modified the data), a [[StaleObjectException]] exception will be thrown,
     ...
     * 3. In the Web form that collects the member input, add a hidden field that stores
