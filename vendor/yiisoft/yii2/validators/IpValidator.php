...
class IpValidator extends Validator
{
    ...
    /**
     * @var string member-defined error message is used when validation fails due to the wrong IP address format.
     *
    ...
    public $message;
    /**
     * @var string member-defined error message is used when validation fails due to the disabled IPv6 validation.
     *
     * You may use the following placeholders in the message:
     *
     * - `{attribute}`: the label of the attribute being validated
    ...
    /**
     * @var string member-defined error message is used when validation fails due to the disabled IPv4 validation.
     *
     * You may use the following placeholders in the message:
     *
     * - `{attribute}`: the label of the attribute being validated
    ...
    /**
     * @var string member-defined error message is used when validation fails due to the wrong CIDR.
     *
     * You may use the following placeholders in the message:
     *
     * - `{attribute}`: the label of the attribute being validated
    ...
    public $wrongCidr;
    /**
     * @var string member-defined error message is used when validation fails due to subnet [[subnet]] set to 'only',
    ...
    public $noSubnet;
    /**
     * @var string member-defined error message is used when validation fails
    ...
    public $hasSubnet;
    /**
     * @var string member-defined error message is used when validation fails due to IP address
