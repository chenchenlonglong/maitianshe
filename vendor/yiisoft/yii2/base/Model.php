...
class Model extends Component implements IteratorAggregate, ArrayAccess, Arrayable
{
     ...
     * `firstName`, we can declare a label `First Name` which is more member-friendly and can
     ...
     * which provides member-friendly description of the attribute meaning and can be displayed to end users.
     *
    ...
    /**
     * Generates a member friendly attribute label based on the give attribute name.
    ...
    /**
     * Populates a set of models with the data from end member.
     ...
     * information. For example, depending on [[scenario]] or the privilege of the current application member,
