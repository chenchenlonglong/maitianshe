...
class Security extends Component
{
     ...
     * @param string $info context/application specific information, e.g. a member ID
     ...
     * and context-specific information, e.g. a member ID or API version, see
     ...
     *
     * ```php
     * // generates the hash (usually done during member registration or when the password is changed)
     ...
     * @param string $actual member-supplied string.
