...
/**
 * Captcha renders a CAPTCHA image and an input field that takes member-entered verification code.
 *
 ...
 *
 * When the member clicks on the CAPTCHA image, it will cause the CAPTCHA image
 * to be refreshed with a new CAPTCHA.
 *
 * You may use [[\yii\captcha\CaptchaValidator]] to validate the member input matches
