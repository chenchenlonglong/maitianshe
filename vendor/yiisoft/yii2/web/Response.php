...
class Response extends \yii\base\Response
{
     ...
     * @param string $attachmentName the file name shown to the member. If null, it will be determined from `$filePath`.
     ...
     * @param string $attachmentName the file name shown to the member.
     * @param array $options additional options for sending the file. The following options are supported:
     *
     ...
     * and sending it to the member. When dealing with a lot of files (or very big files) this can lead to a great
     ...
     *
     * ```php
     * Yii::$app->response->xSendFile('/home/member/Pictures/picture1.jpg');
     * ```
     *
     * @param string $filePath file name with full path
     * @param string $attachmentName file name shown to the member. If null, it will be determined from `$filePath`.
     * @param array $options additional options for sending the file. The following options are supported:
     *
     *  - `mimeType`: the MIME type of the content. If not set, it will be guessed based on `$filePath`
     *  - `inline`: boolean, whether the browser should open the file within the browser window. Defaults to false,
     ...
     * The effect of this method call is the same as the member pressing the refresh button of his browser
