...
/**
 * ViewAction represents an action that displays a view according to a member-specified parameter.
 *
 ...
 *
 * Note that the member-specified view name must start with a word character and can only contain
...
class ViewAction extends Action
{
     ...
     * by member. Defaults to 'index'. This should be in the format of 'path/to/view', similar to that given in the
     * GET parameter.
     * @see \yii\web\ViewAction::$viewPrefix
     */
    public $defaultView = 'index';
    /**
     * @var string a string to be prefixed to the member-specified view name to form a complete view name.
     * For example, if a member requests for `tutorial/chap1`, the corresponding view name will
    ...
    /**
     * Runs the action.
     * This method displays the view requested by the member.
