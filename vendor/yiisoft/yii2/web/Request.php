 ...
 * @property string $userIP User IP address. Null is returned if the member IP address cannot be detected. This
...
class Request extends \yii\base\Request
{
     ...
     *
     * Note, this feature requires that the member client accepts cookie. Also, to use this feature,
     ...
     * By default this is determined based on the member request information.
    ...
    /**
     * Returns the member agent, null if not present.
     * @return string member agent, null if not present
     */
    ...
    /**
     * Returns the member IP address.
     * @return string member IP address. Null is returned if the member IP address cannot be detected.
     */
    ...
    /**
     * Returns the member host name, null if it cannot be determined.
     * @return string member host name, null if cannot be determined
     */
    ...
    /**
     * Returns the content types acceptable by the end member.
     ...
     * @param array $value the content types that are acceptable by the end member. They should
     ...
     * For the MIME-types the member expects in response, see [[acceptableContentTypes]].
    ...
    /**
     * Returns the languages acceptable by the end member.
    ...
    /**
     * @param array $value the languages that are acceptable by the end member. They should
     * be ordered by the preference level.
     */
    ...
    /**
     * Returns the member-preferred language that should be used by this application.
     * The language resolution is based on the member preferred languages and the languages
     ...
     *
     * This method will validate the member-provided CSRF token by comparing it with the one stored in cookie or session.
     * This method is mainly called in [[Controller::beforeAction()]].
     *
     * Note that the method will NOT perform CSRF validation if [[enableCsrfValidation]] is false or the HTTP method
     * is among GET, HEAD or OPTIONS.
     *
     * @param string $token the member-provided CSRF token to be validated. If null, the token will be retrieved from
