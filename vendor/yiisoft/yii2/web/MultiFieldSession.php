 ...
 *
 * For example the ID of the authenticated member can be saved as separated column in the MySQL 'session' table,
 * which allows to query all active sessions for a particular member or terminate them at will.
 *
