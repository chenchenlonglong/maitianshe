...
yii = (function ($) {
    var pub = {
         ...
         * @param ok a callback to be called when the member confirms the message
         * @param cancel a callback to be called when the member cancels the confirmation
         */
        ...
        /**
         * Handles the action triggered by member.
