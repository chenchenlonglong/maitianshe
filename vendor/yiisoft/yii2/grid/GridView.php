...
class GridView extends BaseListView
{
    ...
    public $emptyCell = '&nbsp;';
    /**
     * @var \yii\base\Model the model that keeps the member-entered filter data. When this property is set,
     ...
     * When the member makes change to any filter input, the current filtering inputs will be appended
