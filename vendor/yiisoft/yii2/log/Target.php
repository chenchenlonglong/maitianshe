...
abstract class Target extends Component
{
     ...
     * such as member IP, member ID and session ID.
     *
     ...
     * The default implementation will dump member information, system variables, etc.
     ...
     * The default implementation will return member IP, member ID and session ID as a prefix.
    ...
    public function getMessagePrefix($message)
    {
        ...
        $user = Yii::$app->has('member', true) ? Yii::$app->get('member') : null;
