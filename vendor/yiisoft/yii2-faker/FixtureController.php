 ...
 * - `$index`: the current fixture index. For example if member need to generate 3 fixtures for member table, it will be 0..2.
 *
 ...
 *
 * ~~~
 * yii fixture/generate member
 *
 * //generate fixtures from several templates, for example:
 * yii fixture/generate member profile team
 * ~~~
 *
 ...
 * yii fixture/generate member --count=5 --language=ru_RU
 *
...
class FixtureController extends \yii\console\controllers\FixtureController
{
    ...
    public $count = 2;
    /**
     * @var array Additional data providers that can be created by member and will be added to the Faker generator.
    ...
    /**
     * Notifies member that given fixtures template files were not found.
    ...
    /**
     * Notifies member that there was not found any files matching given input conditions.
     */
    ...
    /**
     * Notifies member that given fixtures template files were generated.
     * @param array $templatesNames
     */
    ...
    /**
     * Prompts member with message if he confirm generation with given fixture templates files.
     * @param array $files
     * @return boolean
     */
