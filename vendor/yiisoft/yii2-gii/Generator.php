 ...
 *
 * A generator instance is responsible for taking member inputs, validating them,
 ...
 * - [[generate()]]: generates the code based on the current member input and the specified code template files.
...
abstract class Generator extends Model
{
    ...
    public $templates = [];
    /**
     * @var string the name of the code template that the member has selected.
    ...
    /**
     * Generates the code based on the current member input and the specified code template files.
     ...
     * This method validates whether the member selects an existing template
