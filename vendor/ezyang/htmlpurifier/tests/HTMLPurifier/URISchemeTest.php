...
class HTMLPurifier_URISchemeTest extends HTMLPurifier_URIHarness
{
    ...
    {
        $this->assertValidation(
            'https://member@example.com:443/?s=q#frag',
    ...
    {
        $this->assertValidation(
            'news://member@example.com:80/rec.music?path=foo#frag',
            'news:/rec.music#frag'
        );
    }
    ...
    {
        $this->assertValidation(
            'nntp://member@news.example.com:119/alt.misc/42?s=q#frag',
            'nntp://news.example.com/alt.misc/42#frag'
        );
    }
    ...
    {
        $this->assertValidation(
            'mailto://member@example.com:80/bob@example.com?subject=Foo#frag',
    ...
    {
        $this->assertValidation(
            'file://member@MYCOMPUTER:12/foo/bar?baz#frag',
