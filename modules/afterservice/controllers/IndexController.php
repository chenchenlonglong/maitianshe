...
class IndexController extends CommonController
{
    ...
    public  function actionIndex(){
        ...
        if($where){
          $data=  $model->getPage($model->find(),$page_info[0],$page_info[1],"add_time desc ",$where);
        }else{
            $data= $model->getPage($model->find(),$page_info[0],$page_info[1],"add_time desc ");
        }
    ...
    public  function actionAdd(){
        ...
        return $this->renderPartial("add",["order_id"=>$order_id,
            ...
            "consignee"=>$consignee,"goods_name"=>$goods_name,"model"=>$model,
    ...
    public function  actionEdit(){
        ...
        $afterModel->receive_name=$post["consignee"];
        ...
        $afterModel->result=0;
        $afterModel->add_time=time();

        $image1 =UploadedFile::getInstance($afterModel, "image_1");
        $image2 =UploadedFile::getInstance($afterModel, "image_2");
        $image3 =UploadedFile::getInstance($afterModel, "image_3");
    ...
    public  function actionChange(){
        ...
        if($id){
            ...
            return $this->renderPartial("change",["data"=>$result,"model"=>]);
        }
