...
?>
<form id="pagerForm" method="post" action="index.php?r=user/user/index">
...
<div class="pageHeader">
    <form   onsubmit="return navTabSearch(this);" action="index.php?r=user/user/index" method="post" class="pageForm required-validate">
        <div class="searchBar">
            <table class="searchContent">
                <tr>
                    ...
                    <td >
                        今日新加入数为:<span style="color: red; margin-left: 10px;"><?php echo isset($data["reg_today"])?$data["reg_today"]:0;?>人</span>
                    </td>
                </tr>
            </table>
        </div>
